...
**Random Users:** The "Random User" project is a data fetching application that interacts with a public API to retrieve and display random user information. Built with a focus on simplicity and efficiency, this project leverages the power of modern web technologies to provide a seamless user experience.
...
- [Live Project Demo](https://random-user-generator211.netlify.app/)
...
To deploy this project using `GitHub Pages`, follow the instructions provided below to make your project accessible online;
